...
const hoveredSiblingPlugin = plugin(function ({ addVariant, e }: any) {
  addVariant('hovered-sibling', ({ container }: any) => {
...
const themesConfig = plugin(function ({ addComponents }: any) {
